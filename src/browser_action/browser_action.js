...
var init = function(){
    ...
    $('.status').empty().append('Image Downloader is '+activated?"activated":"decativated");
    activated?$('.status').addClass('active'):$('.status').removeClass('active');
    
    $('.button').empty().append(activated?"Deactivate":"Activate");
    activated?$('.button').addClass('active'):$('.button').removeClass('active');
